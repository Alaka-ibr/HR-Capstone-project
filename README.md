...
Once the numbers were actually right, a few things stood out from my own Pivot Tables (your exact numbers may differ slightly depending on how you handled Resigned, but this is what I found):
...
- **Pay doesn't explain it.** Operations has the *lowest* average salary of the six departments (~$79,800) — but so does IT (~$80,000), which has a much lower attrition rate (16.7%) despite similar pay. So low salary alone doesn't cleanly predict who's leaving; something specific to Operations (workload, management, shift patterns — the data doesn't say) is probably driving it, not compensation alone.
...
- **Bonus payout is heavily concentrated in the upper-middle bands, not the very top.** The "Achieving" band accounts for the single largest share of total bonus payout (~$190K of the ~$502K total), more than "Exceeding" and "Outstanding" combined get individually. That's simply because there are more people clustered in the middle of the performance curve than at the very top — worth knowing if leadership assumes most of the bonus budget goes to the highest performers.
